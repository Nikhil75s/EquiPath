/**
 * Generate seed.sql with real bcrypt hashes
 * Run: node generate_seed_hashes.js
 */
...
('admin@equipath.com', '${adminHash}', 'admin'),
('hr@techcorp.com', '${testHash}', 'employer'),
('recruit@healthplus.com', '${testHash}', 'employer'),
('jobs@eduvision.com', '${testHash}', 'employer'),
('arjun@email.com', '${testHash}', 'jobseeker'),
('priya@email.com', '${testHash}', 'jobseeker'),
('ravi@email.com', '${testHash}', 'jobseeker');
...
(1, '{"education_level":"Bachelor''s","experience_years":3,"typing_wpm":65,"stress_tolerance":"medium","communication":"written","mobility":"seated","work_preference":"remote","skills":["Python","SQL","Excel","Data Visualization"],"disability_type":"Visual"}',
 '{"ability_score":78,"typing_percentile":81,"stress_resilience":70,"communication_score":75,"overall_readiness":78}'),
(2, '{"education_level":"Bachelor''s","experience_years":2,"typing_wpm":80,"stress_tolerance":"high","communication":"written","mobility":"seated","work_preference":"remote","skills":["React","JavaScript","CSS","Communication"],"disability_type":"Mobility"}',
...
`;
  ...
  console.log('✅ seed.sql generated with real bcrypt hashes!');
  console.log('   admin@equipath.com / admin123');
  console.log('   hr@techcorp.com / test123');
  console.log('   arjun@email.com / test123');
}
